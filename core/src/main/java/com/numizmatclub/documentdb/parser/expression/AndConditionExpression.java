 ...
 */
public class AndConditionExpression implements BooleanExpression {

    private final BooleanExpression left;
    private final BooleanExpression right;

    public AndConditionExpression(BooleanExpression left, BooleanExpression right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object o) {
        ...
        AndConditionExpression that = (AndConditionExpression) o;
